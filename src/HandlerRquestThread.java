...
public class HandlerRquestThread implements Runnable {
    ...
    public static final String WEB_ROOT = "D:" + File.separator + "Upload" + File.separator + "test" + File.separator;
     ...
     * return 请求的资源名称
     */
    public String parseRequestHead(InputStream in) {
        try {
            //客户端发起请求会将一些请求数据包含在请求头中
            BufferedReader br = new BufferedReader(new InputStreamReader(in));
            //请求头的第一行包含请求的方式、资源、协议
            ...
            System.out.println("解析请求头失败：" + e.getMessage());
        }
        return null;
    }
